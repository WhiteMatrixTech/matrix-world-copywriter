  ...
  faqs: [
    {
      ...
      questionList: [
        ...
        },
        {
          ...
          answer: `Matrix World is the first open virtual world project simultaneously running on different blockchain networks. The system now supports Ethereum and Flow, and we plan to include more blockchain networks as its persistent and consensus layer.
      ...
      questionList: [
        {
          ...
          answer: `Matrix Land is the smallest territorial unit in Matrix World with finite computation and storage resources. A Land is also represented on several blockchains as a tradable NFT token. For instance, it will be an ERC721 token on Ethereum, whereas on Flow will be an on-chain Flow resource.`,
        },
        {
          question: 'How large is a tile of Matrix Land?',
          answer: `Land parcels are 30m x 30m, or 99ft x 99ft, and there will be a height limitation which we are still deciding. However, if you are our partners or community members, you can apply Super Height for special usage.`,
        },
        {
          ...
          When a group of Lands shares the same owner, the owner can choose to merge the Lands into a Space for larger construction and more complicated application development. The computation resources and storage of the Lands will get merged too.`,
        },
        {
          question: 'What can Land owners do?',
          answer: `The Matrix Lands are tradable and transferable via blockchain networks, and their owners retain complete control over the creations on their Lands in Matrix World. Users can take advantage of traditional 3D open-world features such as building 3D architectures, hosting virtual meetings, exhibiting NFTs, and more advanced functionality such as creating their own 3D decentralized Applications (DApps) using Matrix's built-in computation resources. These DApps include 3D games and 3D marketplace, among others.`,
        },
        {
      ...
      questionList: [
        {
          ...
          answer: `The community land pre-sale is a special event in which up to 5,000 Matrix land parcels on Ethereum and 5,000 Matrix land parcels on the Flow ecosystem will be made available for early members to purchase.
        ...
        },
        {
          ...
          answer: `Each Land parcel's price on Ethereum is 0.2 Ethereum. And for Flow users, the price is the same, but the payment is via FUSD or FLOW at the community pre-sale stage.`,
        },
        {
          question:
        ...
        },
        {
          ...
          offer free NFT airdrops to the owner of several NFT collections who participated in the early access. Please check the detailed list on <a href="https://matrixworld.org/activity">Matrix</a> website.`,
        },
        {
