    ...
    presaleSection: {
      ...
      content: {
        introduction: [
          ...
          `<div class="homePresaleSectionIntro">Individual applicants can apply for up to <span class="blueAndBold">10 Lands</span>, while organizations can apply for up to <span class="blueAndBold">108 Lands</span>.Each land parcel's price is 0.2 ETH（Payment on Flow is via FUSD or FLOW）</div>`,
