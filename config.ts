      ...
      content: {
        ...
        steps: {
          ...
          content: [
            ...
            '<div class="homePresaleSectionStepLine">Once the applicants finish the purchase, they will receive a tradable NFT voucher for the corresponding Land. Owners of the Land NFT voucher can later claim the Land on the <a href="/claim" class="landLink" target="_self">Claim Page</a></div>',
          ],
        },
      },
    },
