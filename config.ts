...
.
        ...
        Thank you for your participation and support! We hope everyone has a great time :D`,
          ...
          title: 'Notification of ChainIDE Airdrop Event Termination',
          content:
            'Dear Matrixers! Matrix team appreciates your great response to the "NFT AIRDROP for ChainIDE users" activity. Unfortunately, it was discovered that there are widespread abuses of creating a massive number of fraudulent accounts on GitHub to take advantage of the NFT airdrop. The Github team found this issue and notified our partner, the ChainIDE team, about the bad influence of bots-created garbage accounts. Therefore, after hours of research and discussion, we have decided to close this activity. Members who already registered and created a project before Oct 12th, 01:00 PM PDT will still be rewarded with special NFTs related to Matrix World accessories. Thanks again, and good luck!',
